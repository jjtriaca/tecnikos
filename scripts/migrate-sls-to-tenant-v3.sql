-- ============================================================================
-- DATA MIGRATION v3: Move SLS operational data from public → tenant_sls
-- ============================================================================
-- Uses PostgreSQL IMPLICIT CAST between schema-qualified enum types
-- ============================================================================
...
-- ══════════════════════════════════════════════════════════════════════
-- STEP 0: Create implicit casts for all enum types between schemas
-- ══════════════════════════════════════════════════════════════════════
CREATE CAST (public."UserRole" AS tenant_sls."UserRole") WITH INOUT AS IMPLICIT;
CREATE CAST (public."ServiceOrderStatus" AS tenant_sls."ServiceOrderStatus") WITH INOUT AS IMPLICIT;
CREATE CAST (public."FinancialEntryType" AS tenant_sls."FinancialEntryType") WITH INOUT AS IMPLICIT;
CREATE CAST (public."FinancialEntryStatus" AS tenant_sls."FinancialEntryStatus") WITH INOUT AS IMPLICIT;
CREATE CAST (public."InstallmentStatus" AS tenant_sls."InstallmentStatus") WITH INOUT AS IMPLICIT;
CREATE CAST (public."CashAccountType" AS tenant_sls."CashAccountType") WITH INOUT AS IMPLICIT;
CREATE CAST (public."BankAccountType" AS tenant_sls."BankAccountType") WITH INOUT AS IMPLICIT;
CREATE CAST (public."PixKeyType" AS tenant_sls."PixKeyType") WITH INOUT AS IMPLICIT;
CREATE CAST (public."StatementLineStatus" AS tenant_sls."StatementLineStatus") WITH INOUT AS IMPLICIT;
CREATE CAST (public."QuoteStatus" AS tenant_sls."QuoteStatus") WITH INOUT AS IMPLICIT;
CREATE CAST (public."QuoteItemType" AS tenant_sls."QuoteItemType") WITH INOUT AS IMPLICIT;
CREATE CAST (public."WaitStatus" AS tenant_sls."WaitStatus") WITH INOUT AS IMPLICIT;
...
INSERT INTO public."Company" (
  ...
  'Tecnikos Admin',
  'Tecnikos',
  NULL, NULL, 'admin@tecnikos.com.br', 'ATIVA',
  40, 60, 3.0,
  'SN', 1, 'A', 1000,
...
-- ══════════════════════════════════════════════════════════════════════
-- STEP 7: Clean up casts and re-enable triggers
-- ══════════════════════════════════════════════════════════════════════
DROP CAST IF EXISTS (public."UserRole" AS tenant_sls."UserRole");
DROP CAST IF EXISTS (public."ServiceOrderStatus" AS tenant_sls."ServiceOrderStatus");
DROP CAST IF EXISTS (public."FinancialEntryType" AS tenant_sls."FinancialEntryType");
DROP CAST IF EXISTS (public."FinancialEntryStatus" AS tenant_sls."FinancialEntryStatus");
DROP CAST IF EXISTS (public."InstallmentStatus" AS tenant_sls."InstallmentStatus");
DROP CAST IF EXISTS (public."CashAccountType" AS tenant_sls."CashAccountType");
DROP CAST IF EXISTS (public."BankAccountType" AS tenant_sls."BankAccountType");
DROP CAST IF EXISTS (public."PixKeyType" AS tenant_sls."PixKeyType");
DROP CAST IF EXISTS (public."StatementLineStatus" AS tenant_sls."StatementLineStatus");
DROP CAST IF EXISTS (public."QuoteStatus" AS tenant_sls."QuoteStatus");
DROP CAST IF EXISTS (public."QuoteItemType" AS tenant_sls."QuoteItemType");
DROP CAST IF EXISTS (public."WaitStatus" AS tenant_sls."WaitStatus");
