  ...
  // ── ORÇAMENTOS DE OBRAS (PoolBudget) — DADOS REAIS hoje ──
  {
    ...
    groups: [
      { label: "Orçamento", icon: "📄", fields: [
        ...
        T("{climateCity}", "Cidade-clima (aquecedor)", "🌡️"),
        T("{climateState}", "UF / região solar", "🗺️"),
      ...
      { label: "Piscina (dimensões)", icon: "📐", fields: [
        ...
        T("{poolDepth}", "Profundidade principal (m)", "📐"),
        T("{poolMaxDepth}", "Maior profundidade (m)", "📐"),
        T("{poolArea}", "Área (m²)", "📐"),
        T("{poolVolume}", "Volume de água (m³)", "💧"),
        T("{poolPerimeter}", "Perímetro (m)", "📐"),
      ] },
      { label: "Piscina (obra/medidas)", icon: "🧱", fields: [
        T("{poolLengthTotal}", "Comprimento total interno (m)", "📐"),
        T("{poolWidthTotal}", "Largura total interno (m)", "📐"),
        T("{poolPerimeterExt}", "Perímetro externo da borda (m/l)", "📐"),
        T("{poolWallPerimeter}", "Perímetro paredes internas (m/l)", "📐"),
        T("{poolCorners}", "Cantos / cantoneiras (m/l)", "📐"),
        T("{poolWallFloorArea}", "Área parede + fundo (m²)", "🧱"),
        T("{poolWallArea}", "Área da parede (m²)", "🧱"),
        T("{poolRadierArea}", "Radier (m²)", "🧱"),
