...
function buildReportData(budget: any, sectionLabels: Record<string, string>): BudgetReportData {
  ...
  return {
    ...
    dimensions: {
      ...
      // Medidas extras (snapshot salvo no orcamento de obra) — expostas no catalogo.
      maxDepth: Number(d.maxDepth) || 0,
      comprimentoTotal: Number(d.comprimentoTotal) || 0,
      larguraTotal: Number(d.larguraTotal) || 0,
      cantos: Number(d.cantos) || 0,
      perimetroExternoBorda: Number(d.perimetroExternoBorda) || 0,
      perimetroParedesInternas: Number(d.perimetroParedesInternas) || 0,
      areaParedeEFundo: Number(d.areaParedeEFundo) || 0,
      areaParedeM2: Number(d.areaParedeM2) || 0,
      radierM2: Number(d.radierM2) || 0,
      radierM3: Number(d.radierM3) || 0,
      escavacaoM3: Number(d.escavacaoM3) || 0,
    },
