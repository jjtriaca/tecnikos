            ...
            <div className="flex items-center justify-between text-sm text-slate-500">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="rounded-lg border px-3 py-1 text-xs hover:bg-slate-100 disabled:opacity-30"
                >
                  Anterior
                </button>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  {detailInvoice.xmlUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 flex items-center gap-2"
                    >
                      Baixar XML
                    </a>
                  )}
