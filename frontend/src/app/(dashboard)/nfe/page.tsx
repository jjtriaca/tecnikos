    ...
    return (
      <div className="flex items-center justify-between mt-4">
        <p className="text-sm text-slate-500">
          {meta.total} registro{meta.total !== 1 ? "s" : ""} | Pagina {meta.page} de{" "}
          {meta.totalPages}
        </p>
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Importacao NFe</h1>
          <p className="text-sm text-slate-500">
            Importe notas fiscais eletronicas para cadastro automatico de fornecedores e produtos
          </p>
        </div>
        <button
          onClick={openWizard}
