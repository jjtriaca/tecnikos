...
export const BLOCK_CATALOG: CatalogEntry[] = [
  ...
  { type: 'MATERIALS', name: 'Materiais', icon: '📦', description: 'Lista de materiais (descrição + quantidade)', category: 'ACTIONS', color: 'bg-blue-50', borderColor: 'border-blue-300', iconBg: 'bg-blue-500', textColor: 'text-blue-900' },
  { type: 'SERVICES', name: 'Serviços', icon: '🛠️', description: 'Lista de serviços realizados (uma descrição por linha)', category: 'ACTIONS', color: 'bg-blue-50', borderColor: 'border-blue-300', iconBg: 'bg-blue-500', textColor: 'text-blue-900' },
...
export function getDefaultConfig(type: BlockType): Record<string, any> {
  switch (type) {
    ...
    case 'MATERIALS': return { label: 'Liste os materiais utilizados', itemsRequired: true, minItems: 1, minChars: 10, confirmButton: { label: 'Enviar relatório de materiais', color: 'green', icon: '📦' } };
    case 'SERVICES': return { label: 'Liste os serviços realizados', itemsRequired: true, minItems: 1, minChars: 10, confirmButton: { label: 'Enviar Relatório de serviços', color: 'green', icon: '🛠️' } };
