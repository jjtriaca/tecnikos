...
## ✅ DEPLOYED v1.13.16 (05/06) — Bomba de RECIRCULACAO da Bomba de Calor (paridade Solar) + horas por DEMANDA LIQUIDA
...
## - ⚠️ **PENDENTE (proxima sessao):** (1) validar ☀/⏱ no ORCP-00003 REAL → calibrar absorcao/transmissao capa; (2) batendo, LIGAR a mesma conta (demanda liquida) na tabela de consumo da PROPRIA bomba de calor (hoje ainda usa hora fixa `horasFuncionamentoDia` × qtotal/COP — 1 flag); (3) layout: reordenar secoes (selecao/tubulacao/bomba) na ordem exata do Solar, se o usuario quiser.
