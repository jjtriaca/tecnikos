...
## 🟡 PRONTO LOCAL (aguardando deploy) — MECANISMO: dividir lançamento de cartão JÁ PAGO em parcelas por fatura
...
## - 🟡 VAI JUNTO no deploy: v1.13.34 (UX card-fatura: coluna "Ciclo" nas candidatas + cards fixos menores no modal) — ReconciliationTab, já buildado, ainda não deployado.
